...
const APP_EXEC_DIR = process.env.APP_EXEC_DIR || __dirname;
const binding = requireFunc(path.resolve(path.join(APP_EXEC_DIR, './node_sqlite3.node')));
const sqlite3 = module.exports = exports = binding;
...
sqlite3.verbose = function() {
    if (!isVerbose) {
        var trace = require('../node_modules/sqlite3/lib/trace');
        [
            'prepare',
            'get',
            'run',
